...
{
    $req = <<<NANI
SELECT co.idCommande, co.dateCommande,co.debutDate, co.finDate, co.codeEvent, cl.idClient,cl.adresse, cl.ville, cl.cp, cl.email ,cl.nom, cl.prenom, bo.idBornes, bo.prix, bo.libelle
FROM commande co
